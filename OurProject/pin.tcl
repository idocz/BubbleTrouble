...
set_location_assignment PIN_AK4 -to KEY[1] ; #rightarrow
set_location_assignment PIN_AA14 -to KEY[2] ; #left arrow
set_location_assignment PIN_AA15 -to KEY[3] ; #space bar
