...
//lpm_constant CBX_AUTO_BLACKBOX="ALL" ENABLE_RUNTIME_MOD="YES" INSTANCE_NAME="tt22" LPM_CVALUE=00000032 LPM_WIDTH=32 result
...
module  test3_lpm_constant_mua
	...
	defparam
		mgl_prim1.cvalue = 32'b00000000000000000000000000110010,
		mgl_prim1.is_data_in_ram = 0,
		mgl_prim1.is_readable = 0,
		mgl_prim1.node_name = 1953772082,
...
endmodule //test3_lpm_constant_mua
//VALID FILE
...
module test3 (
	...
	test3_lpm_constant_mua	test3_lpm_constant_mua_component (
				.result (sub_wire0));
